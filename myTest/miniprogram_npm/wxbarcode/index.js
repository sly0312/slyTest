...
__DEFINE__(1550720479750, function(require, module, exports) {
module.exports = require('./demo/utils')
}, function(modId) {var map = {"./demo/utils":1550720479751}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1550720479751, function(require, module, exports) {
...
}, function(modId) { var map = {"./barcode":1550720479752,"./qrcode":1550720479753}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1550720479752, function(require, module, exports) {
var CHAR_TILDE = 126;
var CODE_FNC1 = 102;
...
function stringToCode128(text) {
  ...
  function perhapsCodeC(bytes, codeset) { 
    ...
    if ((b < 48 || b > 57) && b != CHAR_TILDE) return codeset; }
     if (bytes.length % 2 == 0) return CODESET.C; else return CODESET.A;
   }
...
__DEFINE__(1550720479753, function(require, module, exports) {
var QR = (function () {
...
return __REQUIRE__(1550720479750);
})()
